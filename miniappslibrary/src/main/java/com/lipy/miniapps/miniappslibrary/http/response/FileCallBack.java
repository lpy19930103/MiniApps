...
import com.lipy.miniapps.miniappslibrary.http.message.OkHttpException;
...
public class FileCallBack implements Callback{
    ...
    public FileCallBack(DefaultResponseHandle handle) {
        this.mListener = handle.mDownLoadResponseListener;
