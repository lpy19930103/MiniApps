package com.lipy.videoplaylibrary.utils;


import com.lipy.videoplaylibrary.BaseVideoPlayerView;
...
public class OrientationUtils {
    ...
    private BaseVideoPlayerView videoPlayer;
     ...
     * @param videoPlayer
     */
    public OrientationUtils(Activity activity, BaseVideoPlayerView videoPlayer) {
...
//                                videoPlayer.getFullscreenButton().setImageResource(videoPlayer.getShrinkImageRes());
//                            } else {
//                                videoPlayer.getFullscreenButton().setImageResource(videoPlayer.getEnlargeImageRes());
//                            }
                            mIsLand = 0;
                            mClick = false;
                        }
