...
/**
 *
 * Created by lipy on 2017/3/8 0009.
 */
public class HotSalePagerAdapter extends PagerAdapter {
    private Context mContext;
    private ArrayList<HomeData.ListBean> mData;
    private LayoutInflater mInflate;
    private ImageLoaderUtil mImageLoader;

    public HotSalePagerAdapter(Context context, ArrayList<HomeData.ListBean> list) {
        mContext = context;
        mData = list;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        final HomeData.ListBean value = mData.get(position % mData.size());
